        ...
        <div class="news-card">
          <div class="news-card-inner">
            <div class="news-card-meta">
              <div class="news-kanji-watermark">報</div>
              <div class="news-badge-tag"><i class="fas fa-bullhorn"></i> Новость клуба</div>
              <div class="news-card-date"><i class="far fa-calendar-alt"></i> ${formatDate(n.createdAt)}</div>
            </div>
            <div class="news-card-body">
              ...
              ${n.filePath ? `
                <div class="news-card-actions">
                  <a href="${fileUrl(n.filePath)}" class="news-card-file" target="_blank"><i class="fas fa-download"></i> Скачать файл</a>
                </div>` : ''}
            </div>
          </div>
        </div>
