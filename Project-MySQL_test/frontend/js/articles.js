        ...
        <div class="article-card" data-id="${a.id}">
          <div class="article-card-inner">
            <div class="article-card-meta">
              <div class="article-kanji-watermark">文</div>
              <div class="article-badge-tag"><i class="fas fa-scroll"></i> Статья</div>
              <div class="article-card-date"><i class="far fa-calendar-alt"></i> ${formatDate(a.createdAt)}</div>
              <div class="article-views"><i class="far fa-eye"></i> ${a.views || 0} просм.</div>
            </div>
            <div class="article-card-body">
              <h3 class="article-card-title">${a.title}</h3>
              ${a.content ? `<p class="article-card-excerpt">${a.content.substring(0, 220)}${a.content.length > 220 ? '...' : ''}</p>` : ''}
              <div class="article-card-actions">
                <span class="article-read-btn">Читать статью <i class="fas fa-arrow-right"></i></span>
